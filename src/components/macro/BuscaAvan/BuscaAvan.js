                        ...
                        <div class="col-6 d-flex justify-content-center">
                            <div class="row seletores">
                                <div class="col-12 d-flex flex-column align-items-center">
                                    ...
                                    <select className="selectBusca" required name="marca" id="marca" onChange={onChange} >
                        ...
                        <div class="col-6 d-flex justify-content-center">
                            <div class="row seletores">
                                <div class="col-12 d-flex flex-column align-items-center">
                                    ...
                                    <select className="selectBusca" required name="familia" id="familia" onChange={onChange} >
                                        <option value="-1" onChange={onChange} selected>Selecione</option>
